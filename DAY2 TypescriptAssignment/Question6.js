var Words = /** @class */ (function () {
    ...
    Words.prototype.setValue = function (input) {
        this.stringName = input;
    };
    Words.prototype.checkString = function () {
        ...
        if (newStringName[0] == "A" || newStringName[0] == "E" || newStringName[0] == "I" || newStringName[0] == "O" || newStringName[0] == "U") {
            for (var i = 0; i < this.stringName.length; i++) {
                if (newStringName[i] !== "A" && newStringName[i] !== "E" && newStringName[i] !== "I" && newStringName[i] !== "O" && newStringName[i] !== "U") {
                    countConsonants++;
                }
            }
